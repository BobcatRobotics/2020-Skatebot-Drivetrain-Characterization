...
public class Robot extends TimedRobot {
  ...
  static private double WHEEL_DIAMETER = 3.875;
  static private double ENCODER_EDGES_PER_REV = 12288;
  ...
  public void robotInit() {
    ...
    leftMaster = new WPI_TalonSRX(7);
    leftMaster.setInverted(false);
    leftMaster.setSensorPhase(false);
    leftMaster.setNeutralMode(NeutralMode.Brake);

    rightMaster = new WPI_TalonSRX(8);
    ...
    AHRS navx = new AHRS(SPI.Port.kMXB);
